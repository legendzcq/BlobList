...
> - 该面试题解答[github 地址版本](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fcolourful987%2Fbytedance-alibaba-interview)目前已经完结，可自行下载pdf进行阅读，仅做参考，对于有问题的解答可提 issue，欢迎 star fork。
...
![img](https:////upload-images.jianshu.io/upload_images/861390-37a8d4806aa85ae1.png)
...
Method 同样是个对象，封装了方法名和实现，关于 [Type Encodings](https://links.jianshu.com/go?to=https%3A%2F%2Fdeveloper.apple.com%2Flibrary%2Farchive%2Fdocumentation%2FCocoa%2FConceptual%2FObjCRuntimeGuide%2FArticles%2FocrtTypeEncodings.html%23%2F%2Fapple_ref%2Fdoc%2Fuid%2FTP40008048-CH100-SW1)。
...
> 摘自[iOS App冷启动治理](https://links.jianshu.com/go?to=https%3A%2F%2Fjuejin.im%2Fpost%2F5c0a17d6e51d4570cf60d102%3Futm_source%3Dgold_browser_extension) 一文中对 Dyld 在各阶段所做的事情：
...
> 解答参考自瓜神的[ weak 弱引用的实现方式](https://links.jianshu.com/go?to=https%3A%2F%2Fwww.desgard.com%2FiOS-Source-Probe%2FObjective-C%2FRuntime%2Fweak%20%E5%BC%B1%E5%BC%95%E7%94%A8%E7%9A%84%E5%AE%9E%E7%8E%B0%E6%96%B9%E5%BC%8F.html) 。
...
![img](https:////upload-images.jianshu.io/upload_images/861390-12e790377bc49b69.png?imageMogr2/auto-orient/strip|imageView2/2/w/1176/format/webp)
...
> 摘自[瓜地](https://links.jianshu.com/go?to=https%3A%2F%2Fwww.desgard.com%2FiOS-Source-Probe%2FObjective-C%2FRuntime%2F%E6%B5%85%E8%B0%88Associated%20Objects.html)：OBJC_ASSOCIATION_ASSIGN类型的关联对象和`weak`有一定差别，而更加接近于`unsafe_unretained`，即当目标对象遭到摧毁时，属性值不会自动清空。（翻译自[Associated Objects](https://links.jianshu.com/go?to=http%3A%2F%2Fnshipster.com%2Fassociated-objects%2F)）
>
> 同样是[Associated Objects](https://links.jianshu.com/go?to=http%3A%2F%2Fnshipster.com%2Fassociated-objects%2F)文中，总结了三个关于Associated Objects用法：

> - **为Class添加私有成员**：例如在AFNetworking中，[在UIImageView里添加了**imageRequestOperation**对象](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2FAFNetworking%2FAFNetworking%2Fblob%2F2.1.0%2FUIKit%2BAFNetworking%2FUIImageView%2BAFNetworking.m%23L57-L63)，从而保证了异步加载图片。
> - **为Class添加共有成员**：例如在FDTemplateLayoutCell中，使用Associated Objects来缓存每个cell的高度（[代码片段1](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fmconintet%2FUITableView-FDTemplateLayoutCell%2Fblob%2Fmaster%2FClasses%2FUITableView%2BFDIndexPathHeightCache.m%23L124)、[代码片段2](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fmconintet%2FUITableView-FDTemplateLayoutCell%2Fblob%2Fmaster%2FClasses%2FUITableView%2BFDKeyedHeightCache.m%23L81)）。通过分配不同的key，在复用cell的时候即时取出，增加效率。
> - **创建KVO对象**：建议使用category来创建关联对象作为观察者。可以参考[*Objective-C Associated Objects*](https://links.jianshu.com/go?to=http%3A%2F%2Fkingscocoa.com%2Ftutorials%2Fassociated-objects%2F)这篇文的例子。
...
认真研读、你可以在这里找到答案[轻松过面：一文全解iOS通知机制(经典收藏)](https://links.jianshu.com/go?to=https%3A%2F%2Fjuejin.im%2Fpost%2F5e5fc16df265da575155723b)
...
![img](https:////upload-images.jianshu.io/upload_images/861390-c6f11ee35006dd1b.png?imageMogr2/auto-orient/strip|imageView2/2/w/1024/format/webp)

kvo.png

那么如何验证上面的说法呢？很简单，借助runtime 即可，测试代码请点击[这里](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fcolourful987%2F2020-Read-Record%2Ftree%2Fmaster%2Fsamples%2F02-25-KVO):
...
> 以下解决方案出自 [iOS 开发：『Crash 防护系统』（二）KVO 防护](https://links.jianshu.com/go?to=https%3A%2F%2Fjuejin.im%2Fpost%2F5d67b720f265da039a289bb4) 一文。
...
> References：
>
> - [iOS底层原理总结篇-- 深入理解 KVC\KVO 实现机制](https://links.jianshu.com/go?to=https%3A%2F%2Fjuejin.im%2Fpost%2F5c2189dee51d454517589c8b)
> - [iOS 开发：『Crash 防护系统』（二）KVO 防护](https://links.jianshu.com/go?to=https%3A%2F%2Fjuejin.im%2Fpost%2F5d67b720f265da039a289bb4)
> - [ValiantCat](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2FValiantCat) / **[XXShield](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2FValiantCat%2FXXShield)**（第三方框架）
> - [JackLee18](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2FJackLee18) / **[JKCrashProtect](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2FJackLee18%2FJKCrashProtect)**（第三方框架）
> - [大白健康系统 -- iOS APP运行时 Crash 自动修复系统](https://links.jianshu.com/go?to=https%3A%2F%2Fneyoufan.github.io%2F2017%2F01%2F13%2Fios%2FBayMax_HTSafetyGuard)
...
2. `oc`怎么实现多继承？怎么面向切面（可以参考[Aspects深度解析-iOS面向切面编程](https://links.jianshu.com/go?to=https%3A%2F%2Fjuejin.im%2Fpost%2F5e13c4366fb9a047f42e6406)）
